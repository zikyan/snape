...
if(isFocused){
      db.collectionGroup('posts').onSnapshot(snapshot => {
        ...
        setDATA(res?.filter(function (e) {
          return (
            e.tag1 == 'story' || e.tag1 == 'Story' || e.tag1 == 'STORY' || 
            e.tag2 == 'story' || e.tag2 == 'Story' || e.tag2 == 'STORY' || 
            e.tag3 == 'story' || e.tag3 == 'Story' || e.tag3 == 'STORY' || 
            e.tag4 == 'story' || e.tag4 == 'Story' || e.tag4 == 'STORY' || 
            e.tag5 == 'story' || e.tag5 == 'Story' || e.tag5 == 'STORY'
          )
      }));
