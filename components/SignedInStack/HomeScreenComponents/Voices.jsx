...
if(isFocused){
      db.collectionGroup('posts').onSnapshot(snapshot => {
        ...
        setDATA(res?.filter(function (e) {
          return (
            e.tag1 == 'voice' || e.tag1 == 'Voice' || e.tag1 == 'VOICE' || 
            e.tag2 == 'voice' || e.tag2 == 'Voice' || e.tag2 == 'VOICE' || 
            e.tag3 == 'voice' || e.tag3 == 'Voice' || e.tag3 == 'VOICE' || 
            e.tag4 == 'voice' || e.tag4 == 'Voice' || e.tag4 == 'VOICE' || 
            e.tag5 == 'voice' || e.tag5 == 'Voice' || e.tag5 == 'VOICE'
          )
      }));
        ...
        <FlatList showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 70 }} style={styles.viralsBelow(theme)} data={DATA} renderItem={(itemList)=>{
          ...
          <View style={styles.container(theme)}>
              ...
              <View>
                ...
                <Audio DATA={itemList.item.voice} />
